...
public class ApplicationTest {
    ...
    public void renderGamePage() {
        Content html = views.html.game.render("Let's Play!", new Board().getCells(), EMPTY, false);
        assertEquals("text/html", html.contentType());
    ...
    public void announcesXWinner() {
        Content html = views.html.game.render("Let's Play!", new Board().getCells(), X, false);
        assertEquals("text/html", html.contentType());
    ...
    public void announcesOWinner() {
        Content html = views.html.game.render("Let's Play!", new Board().getCells(), O, false);
        assertEquals("text/html", html.contentType());
    ...
    public void announcesDraw() {
        Content html = views.html.game.render("Let's Play!", new Board().getCells(), EMPTY, true);
        assertEquals("text/html", html.contentType());
